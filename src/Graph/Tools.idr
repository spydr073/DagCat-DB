...
--echoEncoder : String -> String
--echoEncoder name = concat [ name , " : NatIso String"]

--echoRelation : String -> String

--dbRelationSet : List String -> Map Nat ()
